...
const Skill = ({ name, x, y }) => {
  return (
    <motion.div
      className='flex items-center justify-center rounded-full font-semibold bg-dark text-light dark:bg-light dark:text-dark py-1 sm:py-3  px-2 sm:px-6 shadow-dark cursor-pointer absolute'
...
const Skills = () => {
  return (
    <>
      ...
      <div className='w-full h-screen relative  text-xs sm:text-sm md:text-md flex items-center justify-center rounded-full dark:bg-circularDark bg-circularLight2 sm:bg-circularLight'>
        <motion.div
          className='flex items-center justify-center rounded-full font-semibold bg-dark text-light  dark:bg-light dark:text-dark p-3 sm:p-8 shadow-dark cursor-pointer'
          whileHover={{ scale: 1.05 }}
        >
          Web
        </motion.div>
